		...
		liteBox.prototype = {
			...
			buildLitebox: function() {
				// Variables
					...
					$close = $('<div>', { 'class': 'litebox-close ' + this.options.closeTip }),
					$error = $('<div class="litebox-error"><span>' + this.options.errorMessage + '</span></div>'),
					$prevNav = $('<div>', { 'class': 'litebox-nav litebox-prev ' + this.options.prevTip }),
					$nextNav = $('<div>', { 'class': 'litebox-nav litebox-next ' + this.options.nextTip }),
